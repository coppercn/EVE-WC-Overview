...
当你安装完成后，你的总览应该有七栏，分别是航行、战斗、目标、生产、友军、跑蛋以及特殊。这七栏已经能够满足你的大部分日常需求。平时刷怪、散打、跑路用默认的这七栏一般就够了。但是总览里当然不仅仅只有这些，打开总览设置，在Overview Tabs里面的Overview Presets你们可以找到对应分类的更多预设。除此之外在Bracket Presets还可以选择不同的图标预设（平常你能在grid上看见的图标）。
